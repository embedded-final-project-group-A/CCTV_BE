...
def insert_sample_data(conn):
    ...
    # Event 추가
    events = [
        (user1_id, store1_id, cam1_id, get_type_id("theft"), "http://localhost:8000/output/clips/helmet_clip_32.mp4", "2025-05-27T12:00:00"),
        (user1_id, store1_id, cam1_id, get_type_id("abandonment"), "http://localhost:8000/output/clips/helmet_clip_0.mp4", "2025-05-26T12:05:00"),
